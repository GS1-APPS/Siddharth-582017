...
<form:form commandName="memberAndUserCommand" role="form" action="<%= actionUrl %>">
  <form:errors path="*" cssClass="alert alert-danger" element="div" />
  <div class="form-group">
    <label>GLN</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.gln" />
  </div>
  <div class="form-group">
    <label>Company Name</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.companyName" />
  </div>
  <div class="form-group">
    <label>Address 1</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.address1" />
  </div>
  <div class="form-group">
    <label>Address 2</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.address2" />
  </div>
  <div class="form-group">
    <label>City</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.city" />
  </div>
  <div class="form-group">
    <label>State</label>
    <form:select class="form-control" cssErrorClass="form-control alert-danger" path="member.state" >
  ...
  <div class="form-group">
    ...
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.postalCode" />
  </div>
  <div class="form-group">
    <label>Member ID (from IMIS)</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.memberId" />
  </div>
  <div class="form-group">
    <label>GS1 Company Prefixes</label>
    <form:textarea rows="3" type="text" class="form-control" cssErrorClass="form-control alert-danger" path="member.gcps" />
  </div>
  ...
  <sgl:attributeGroupFormControls 
  	...
  	appAction="<%= Action.CREATE %>" 
  	moduleDesc="<%= moduleDesc %>" />
  <% } %>
  <c:if test="<%= editUsername %>">
  <div class="form-group">
    <label>E-mail Address</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="user.email" />
  </div>
  </c:if>
  <div class="form-group">
    <label>First Name</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="user.firstName" />
  </div>
  <div class="form-group">
    <label>Last Name</label>
    <form:input type="text" class="form-control" cssErrorClass="form-control alert-danger" path="user.lastName" />
  </div>

   <div class="form-group">
    <label>Time Zone</label>
    <form:select class="form-control" cssErrorClass="form-control alert-danger" path="user.timezone" items="<%= timezones %>"/>
  </div>
