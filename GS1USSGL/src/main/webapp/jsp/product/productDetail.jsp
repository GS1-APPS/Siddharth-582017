...
<%
	...
	if (product != null)
	{
		...
		if (attributes.getAttribute("gpcCategoryCode") != null)
		{
			gpcCategoryCode = attributes.getAttribute("gpcCategoryCode");	
		}		
	}
...
<h1>Product Details for <%=product.getGtin() %></h1>
	   	...
	   	<c:if test="<%= imageUrl != null %>">
	    	<tr>
	    		...
	    		<td valign="middle">
	    			...
	    			Target Market: <b><%= countryCodes.get(targetMarket) %></b><br/>
	    			Company Name: <b><%=companyName %></b><br/>
	    			Brand Name: <b><%=brandName %></b><br/>
	    			Label Description: <b><%=labelDesc %></b><br/>
	    			Product Classification: <b><%=gpcCategoryCode %></b><br/>
	    			Information Provider GLN: <b><%= product.getAttributes().getAttribute("informationProviderGLN") %></b><br/>
	    			Language Code: <b><%= product.getAttributes().getAttribute("itemDataLanguage") %></b>
				</td>
	    	</tr>
	    </c:if>
	   	<c:if test="<%= imageUrl == null %>">
