...
<c:when test="<%= user == null %>">
  <section>
      ...
      <p>Use this portal to register your products for <strong>DW</strong>Codes.</p>
      ...
      <div class="row">
          <div class="col-sm-5">
              <div class="content-module-wrapper top-border-orange">
                  <div class="content-module content-module-padding">
                      <h4>Existing <strong>DW</strong>Code User</h4>
                      <p>Log in to register <strong>DW</strong>Codes, view account information, and access <strong>DW</strong>Code-related tools.</p>
          ...
          <div class="col-sm-5">
              <div class="content-module-wrapper top-border-blue">
                  <div class="content-module content-module-padding">
                      <h4>No <%= WebappUtil.shortProductHtml() %> account?</h4>
                      <p>Click below to get information about <strong>DW</strong>Codes or for portal sign-up instructions.</p>
                      <a href="https://sites.gs1us.org/mobilescan/login" class="btn-lg btn-margin btn-primary bg-blue" role="button"><strong>DW</strong>Code Portal Registration</a><br><br>
                  </div>
              </div>
          </div>
      </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="color-blue">This portal is designed to help you register products, plus add or manage product attributes around an existing GTIN. This registration process is important in helping to register and create a <strong>DW</strong>Code.</p>
...
<p>
The <%= WebappUtil.longProductHtml() %> lets you register your products and data attributes, and sign up for
